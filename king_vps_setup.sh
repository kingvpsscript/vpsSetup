...
# [Include all admin functions here: add_ssh_user, add_v2ray_user, change_port, update_domain, list_ports, admin_menu]
...
EOF
    ...
    echo "You can now use the admin script by running: $ADMIN_SCRIPT"
}
